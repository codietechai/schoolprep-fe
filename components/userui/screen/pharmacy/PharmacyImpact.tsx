...
import img from '@/components/userui/components/images/pharmacy/graph.webp';

const PharmacyImpact = () => {
  return (
    <div className="bg-white">
      <div className="res-padding m-auto flex max-w-[1280px] flex-col gap-10 rounded-2xl bg-[#4B70F5] px-4 lg:flex-row lg:px-16">
        <div className="space-y-4 lg:w-[600px]">
          <h2 className="heading text-center text-white lg:text-left ">
            Impact we create
          </h2>
          <p className="sub-head text-center text-white lg:w-[600px] lg:text-left">
        ...
        <div className="flex w-full flex-col items-center">
          ...
          <div className="flex gap-4 text-white">
            ...
            <div className="">
              <p className="">Your performance is 30%</p>
              <p className="">better compare to last month</p>
            </div>
          </div>
        </div>
      </div>
