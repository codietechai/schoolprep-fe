                ...
                <table>
                  ...
                  <tbody>
                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                      ...
                      <td>
                        <Link href="/invoice/preview">#46894</Link>
                      </td>
                      <td>$56.07</td>
                      <td>
                    ...
                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                      ...
                      <td>
                        <Link href="/invoice/preview">#76894</Link>
                      </td>
                      <td>$126.04</td>
                      <td>
                    ...
                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                      ...
                      <td>
                        <Link href="/invoice/preview">#66894</Link>
                      </td>
                      <td>$56.07</td>
                      <td>
                        <span className="badge bg-success shadow-md dark:group-hover:bg-transparent">
...
export default ComponentDashboardSales;
